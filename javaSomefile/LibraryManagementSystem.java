...
public class LibraryManagementSystem {
    ...
    private void createMainFrame() {
        ...
        // Add Book Action
        addButton.addActionListener(_ -> createAddBookFrame());

        // Delete Book Action
        deleteButton.addActionListener(_ -> createDeleteBookFrame());
    ...
    private void createAddBookFrame() {
        ...
        cancelButton.addActionListener(_ -> addFrame.dispose());
    ...
    private void createDeleteBookFrame() {
        ...
        // Cancel Button Action
        cancelButton.addActionListener(_ -> deleteFrame.dispose());
